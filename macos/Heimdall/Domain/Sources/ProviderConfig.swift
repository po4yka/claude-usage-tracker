...
public struct HeimdallConfig: Codable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.claude = try container.decodeIfPresent(ProviderConfig.self, forKey: .claude) ?? HeimdallConfig.default.claude
        self.codex = try container.decodeIfPresent(ProviderConfig.self, forKey: .codex) ?? HeimdallConfig.default.codex
        self.mergeIcons = try container.decodeIfPresent(Bool.self, forKey: .mergeIcons) ?? HeimdallConfig.default.mergeIcons
        self.showUsedValues = try container.decodeIfPresent(Bool.self, forKey: .showUsedValues) ?? HeimdallConfig.default.showUsedValues
        self.refreshIntervalSeconds = try container.decodeIfPresent(Int.self, forKey: .refreshIntervalSeconds) ?? HeimdallConfig.default.refreshIntervalSeconds
        self.resetDisplayMode = try container.decodeIfPresent(ResetDisplayMode.self, forKey: .resetDisplayMode) ?? HeimdallConfig.default.resetDisplayMode
        self.checkProviderStatus = try container.decodeIfPresent(Bool.self, forKey: .checkProviderStatus) ?? HeimdallConfig.default.checkProviderStatus
        self.localNotificationsEnabled = try container.decodeIfPresent(Bool.self, forKey: .localNotificationsEnabled) ?? false
        self.helperPort = try container.decodeIfPresent(Int.self, forKey: .helperPort) ?? HeimdallConfig.default.helperPort
    }
