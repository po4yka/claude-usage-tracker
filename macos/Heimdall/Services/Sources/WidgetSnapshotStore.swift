...
public enum WidgetSnapshotStore {
    public static let appGroupID = "group.dev.po4yka.heimdall"
...
public struct AppGroupWidgetSnapshotStore: WidgetSnapshotWriter {
    public init() {}

    public func save(_ snapshot: WidgetSnapshot) throws -> WidgetSnapshotSaveResult {
