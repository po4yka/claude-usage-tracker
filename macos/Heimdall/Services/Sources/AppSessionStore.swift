...
public final class UserDefaultsAppSessionStateStore: @unchecked Sendable, AppSessionStatePersisting {
    private enum Keys {
        static let selectedProvider = "heimdall.app_session.selected_provider"
        static let selectedMergeTab = "heimdall.app_session.selected_merge_tab"
        static let liveMonitorFocus = "heimdall.app_session.live_monitor.focus"
        static let liveMonitorDensity = "heimdall.app_session.live_monitor.density"
        static let liveMonitorHiddenPanels = "heimdall.app_session.live_monitor.hidden_panels"
    }
...
public final class AppSessionStore {
    ...
    public var installationID: String {
        didSet {
            self.installationIDStore.saveInstallationID(self.installationID)
        }
    }
    ...
    public init(
        ...
        self.installationID = installationIDStore.loadInstallationID() ?? UUID().uuidString.lowercased()
