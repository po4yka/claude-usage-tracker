...
struct MenuProjectionBuilderTests {
    ...
    func menuTitleHonorsShowUsedValues() {
        let leftConfig = HeimdallConfig.default
        let usedConfig = HeimdallConfig(
            claude: HeimdallConfig.default.claude,
            codex: HeimdallConfig.default.codex,
            mergeIcons: HeimdallConfig.default.mergeIcons,
            showUsedValues: true,
            refreshIntervalSeconds: HeimdallConfig.default.refreshIntervalSeconds,
            resetDisplayMode: HeimdallConfig.default.resetDisplayMode,
            checkProviderStatus: HeimdallConfig.default.checkProviderStatus,
            localNotificationsEnabled: HeimdallConfig.default.localNotificationsEnabled,
            helperPort: HeimdallConfig.default.helperPort
        )
        let presentation = ProviderPresentationState(
            provider: .codex,
            snapshot: Self.codexSnapshot(),
