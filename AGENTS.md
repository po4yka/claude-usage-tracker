# Codex Usage Tracker -- Development Guide

## Project

Local Codex usage analytics dashboard. Rust binary with embedded web UI, OAuth-based rate limit monitoring, and webhook notifications.
...
src/
  ...
  oauth/
    ...
    credentials.rs     -- Read ~/.Codex/.credentials.json, token refresh via platform.Codex.com
...
When editing dashboard files (`src/ui/`), follow the design skill at `.Codex/skills/industrial-design/SKILL.md`. Key rules:
