...
description: Premium data dashboard design rules for claude-usage-tracker. Enforces editorial typography, warm monochrome palette, proper data density, Chart.js theming, and anti-AI-slop patterns. Apply when editing HTML, CSS, or TypeScript UI files.
---
