...
APP_ENTITLEMENTS="${4:-${HEIMDALL_APP_ENTITLEMENTS:-$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)/macos/Heimdall/App/Heimdall.entitlements}}"
WIDGET_ENTITLEMENTS="${5:-${HEIMDALL_WIDGET_ENTITLEMENTS:-$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)/macos/Heimdall/Widget/HeimdallWidget.entitlements}}"
