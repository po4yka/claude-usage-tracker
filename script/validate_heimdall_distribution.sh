...
STAGING_DIR="$1"
APP_BUNDLE="$STAGING_DIR/Heimdall.app"
APP_BINARY="$APP_BUNDLE/Contents/MacOS/Heimdall"
HELPER_BINARY="$APP_BUNDLE/Contents/Helpers/heimdall"
WIDGET_BUNDLE="$APP_BUNDLE/Contents/PlugIns/HeimdallWidget.appex"
CLI_BINARY="$STAGING_DIR/bin/heimdall"
FRAMEWORK_DIR="$STAGING_DIR/Frameworks"
SHARED_FRAMEWORK="$FRAMEWORK_DIR/HeimdallShared.framework"
...
EXPECTED_WIDGET_ID="dev.po4yka.heimdall.widget"
