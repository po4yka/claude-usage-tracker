...
PRODUCTS_DIR="$1"
STAGING_DIR="$2"
APP_BUNDLE="$PRODUCTS_DIR/Heimdall.app"
CLI_BINARY="$PRODUCTS_DIR/heimdall"
SHARED_FRAMEWORK="$PRODUCTS_DIR/HeimdallShared.framework"
...
install -m 755 "$CLI_BINARY" "$STAGING_DIR/bin/heimdall"
