# Heimdall Full Parity Roadmap

> **For agentic workers:** Use this as the source of truth for Heimdall parity work. Keep the checkbox state accurate. Do not mark an item complete until code, tests, and verification for that item are done.
...
- [x] `heimdall` CLI compiles and supports `usage`, `cost`, `config validate`, and `config dump`.
...
- [x] Claude web fallback logic where parity needs it. — Phase 13 reviewed
  ...
  lives in
  [WebDashboardScraper.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/PlatformMac/Sources/WebDashboardScraper.swift:129).
- [x] Bundling `claude-usage-tracker` inside `Heimdall.app/Contents/Helpers`.
- [ ] Release signing, entitlements hardening, notarization still need final release-run confirmation.
  - Today `App/Heimdall.entitlements` declares only iCloud +
...
- [macos/Heimdall/Shared/Sources/AppModel.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/AppModel.swift:1)
- [macos/Heimdall/Shared/Sources/HeimdallModels.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/HeimdallModels.swift:1)
- [macos/Heimdall/CLI/Sources/main.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/CLI/Sources/main.swift:1)
...
**Outcome:** Heimdall can securely ingest browser-authenticated sessions needed for web-only dashboard extras.
...
- [macos/Heimdall/Shared/Sources/KeychainStore.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/KeychainStore.swift:1)
- [macos/Heimdall/Shared/Sources/DashboardAdjunctController.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/DashboardAdjunctController.swift:1)
- [macos/Heimdall/App/Sources/SettingsView.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/App/Sources/SettingsView.swift:1)
...
- [macos/Heimdall/Shared/Sources/WebDashboardScraper.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/WebDashboardScraper.swift:1)
- [macos/Heimdall/Shared/Sources/DashboardAdjunctController.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/DashboardAdjunctController.swift:1)
- [macos/Heimdall/Shared/Sources/AppModel.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/AppModel.swift:1)
...
- [macos/Heimdall/App/Sources/MenuBarMeterRenderer.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/App/Sources/MenuBarMeterRenderer.swift:1)
- [macos/Heimdall/App/Sources/RootMenuView.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/App/Sources/RootMenuView.swift:1)
- [macos/Heimdall/App/Sources/HeimdallApp.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/App/Sources/HeimdallApp.swift:6)
- [macos/Heimdall/Shared/Sources/MenuProjectionBuilder.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/MenuProjectionBuilder.swift:1)
...
- [macos/Heimdall/Widget/Sources/HeimdallWidget.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Widget/Sources/HeimdallWidget.swift:1)
- [macos/Heimdall/Shared/Sources/WidgetSnapshotStore.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/WidgetSnapshotStore.swift:1)
- [macos/Heimdall/Shared/Sources/AppModel.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/AppModel.swift:1)
...
**Outcome:** `heimdall` is a serious parity surface, not just a debug helper.
...
- [macos/Heimdall/CLI/Sources/main.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/CLI/Sources/main.swift:1)
- [macos/Heimdall/Shared/Sources/HeimdallAPIClient.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/HeimdallAPIClient.swift:1)

**Acceptance**

- [x] `heimdall usage` and `heimdall cost` are usable without knowing app internals.
...
- [x] Bundle `claude-usage-tracker` into `Heimdall.app/Contents/Helpers`.
...
- [macos/Heimdall/Shared/Sources/HeimdallHelperController.swift](/Users/po4yka/GitRep/heimdall/macos/Heimdall/Shared/Sources/HeimdallHelperController.swift:1)
...
- [macos/Heimdall/project.yml](/Users/po4yka/GitRep/heimdall/macos/Heimdall/project.yml:1)
- [.github/workflows/release.yml](/Users/po4yka/GitRep/heimdall/.github/workflows/release.yml:1)
...
**Outcome:** users can install and understand Heimdall without reading source.

- [x] Add README section for Heimdall:
  - [x] what it is
...
Heimdall reaches “full parity” only when all of the following are true:
...
- [ ] `heimdall` CLI is scriptable and source-aware.
